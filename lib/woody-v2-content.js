...
export const v2NavLinks = [
  ...
  { label: "Agenda", href: "/woody-v2/agenda" },
  { label: "Over", href: "/woody-v2/over" },
  { label: "Menu", href: "/woody-v2/menu" },
  { label: "Werken", href: "/woody-v2/werken" },
  { label: "Lokaal", href: "/woody-v2/lokaal" },
  { label: "Groepen", href: "/woody-v2/groepen" },
