// Content for the 5 editorial pages under / (Over · Menu · Werken ·
...
export const woodyV2Pages = {
  over: {
    slug: "over",
    title: "over",
    titleImg: { name: "destadsherberg", color: "rood", alt: "De stadsherberg van nu" },
    layout: "single",
    intro: "Je komt binnen als vreemde. Je gaat weg als bekende.",
    sections: [
      {
        heading: "Wie we zijn",
    ...
    closingImg: { name: "schuifaan", color: "rood", alt: "Schuif aan" },
    photos: [
  ...
  menu: {
    slug: "menu",
    title: "menu",
    titleImg: { name: "schuifaan", color: "rood", alt: "Schuif aan" },
    layout: "stack",
    intro:
  ...
  werken: {
    slug: "werken",
    title: "werken",
    titleImg: { name: "werkenbijwoody", color: "rood", alt: "Werken bij Woody" },
    layout: "triptych",
    intro:
  ...
  lokaal: {
    ...
    sections: [
      ...
      {
        heading: "Voor wie",
        body: "Woody gelooft in teams die niemand achterlaten. Daarom steken we €10.000 in lokale sport.\n\nGeen grote namen. Geen sponsorborden. Gewoon een team dat het samen doet. En van Woody de stamkroeg maakt.",
      },
    ],
