...
export const showcase = [
  ...
  {
    id: "bieren",
    back: "/img/tapwand-bieren.jpg",
    front: "/img/bier-tap-glas.jpg",
    lockup: "100\nBIEREN",
    caption: "Een uitgebreid, regelmatig wisselend assortiment op de tapwand.",
  },
  {
    id: "wijnen",
    back: "/img/wijnwand.jpg",
    front: "/img/wijn-borrel.jpg",
    lockup: "80\nWIJNEN",
    caption: "Verschillende soorten, smaken en prijscategorieën.",
  },
  {
    id: "borrel",
    back: "/img/borrel-tafel.jpg",
    front: "/img/diner-eten.jpg",
    lockup: "LUNCH\nBORREL\nDINER",
    caption: "Bij wijn en bier hoort natuurlijk lekker eten.",
  },
  {
    id: "tapwand",
    back: "/img/tappen-samen.jpg",
    front: "/img/bier-getapt.jpg",
    lockup: "DE\nTAPWAND",
...
export const intro = {
  heading: "Bij Bar Woody draait alles om zelf tappen, proeven en borrelen.",
